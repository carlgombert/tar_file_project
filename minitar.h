...
/*
 * Append each file specified in 'files' to the archive with the name
 * 'archive_name'. You can assume in this project that at least one new file to
 * append is specified. You may also assume that all files to be appended exist.
 * This function should return 0 upon success or -1 if an error occurred.
 */
int append_files_to_archive(const char *archive_name, const file_list_t *files);

/*
 * Add the name of each file contained in the archive identified by
 * 'archive_name' to the 'files' list. NOTE: This function is most obviously
 * relevant to implementing minitar's list operation, but think about how you
 * can reuse it for the update operation. This function should return 0 upon
...
// int update_files_in_archive(const char *archive_name, const file_list_t
// *files);
